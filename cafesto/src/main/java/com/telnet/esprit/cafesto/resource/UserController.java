...
public class UserController {
	...
	public @ResponseBody
	User updateSuperAdmin(@RequestBody SuperAdministrator superAdmin,
			@PathVariable int id) {
		superAdmin.setId(id);
	...
	public @ResponseBody
	User ServiceProvider(@RequestBody ServiceProvider client,
			@PathVariable int id) {
		client.setId(id);
	...
	public @ResponseBody
	User authentification(@RequestBody String email,
